...
const Signup = () => {
  return (
    <div className="min-h-screen flex gap-8 items-center relative ">
      ...
      <div className="flex flex-col justify-center items-center bg-slate-50 w-full h-full md:w-[38%] p-2 xl:p-3 xxl:p-12">
        <div className="mb-5">
          <Image
            src="/logo-dark.svg"
            width={150}
